...
dmr <- read.csv("./data/peakAnno_female_dmr.csv", stringsAsFactors = FALSE)
...
ggsave("./female/DMR_barplot.pdf", width = 6, height = 5)
...
ggsave("./female/DMR_pieplot.pdf", width = 5, height = 5)
...
ggsave("./female/DMR_chr_distribution.pdf", width = 10, height = 5)
