...
run.all.monocle3 <- function(seu_obj, cl_annot, reduction){
  ...
  print('converting...')
  mon = convert.seurat.mon3(seu = seu_obj, assay = "RNA")
  # 2. Pre-process monocle object  
  ...
  #print('adding remove batch')
  #mon <- align_cds(mon, num_dim = 100, alignment_group = "orig.ident")
  print('adding umap...')
  mon <- reduce_dimension(mon,reduction_method='UMAP',
