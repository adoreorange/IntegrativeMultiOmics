...
GSVA_cluster_diff=function(seurat_object=NULL,method="ssgsea",
                           gspath="/home/adore_org/Breg/database/gsea/h.all.v7.1.symbols.gmt",
  ...
  if(species=="mouse"){
    library(biomaRt)
    human=readRDS("/home/adore_org/Breg/database/human_gene_ensembl.rds")
    mouse=readRDS("/home/adore_org/Breg/database/mouse_gene_ensembl.rds")
  ...
  print(dim(total_es))
  #write.csv(total_es,paste0("total_geneset_",filename,".csv"))
  ##find markers part----
