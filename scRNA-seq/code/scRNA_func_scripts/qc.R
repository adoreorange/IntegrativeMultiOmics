basic_qc <- function(input_sce){
  ...
  ggsave(filename="Scatterplot.pdf",plot=p3,h=5,w=5)
  
  p4=FeatureScatter(input_sce, "nCount_RNA", "percent_mito", group.by = "orig.ident", pt.size = 0.5)
  ggsave(filename="Scatterplot2.pdf",plot=p4,h=5,w=5)
  ...
  print(table(input_sce.filt$orig.ident))
